        ...
        public static async Task SeedAsync(IServiceProvider services)
        {
            ...
            var professors = new List<Professor>
            {
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Lecture-based with proof-driven problem sets and research mentorship",
                    Rating        = 0.0,
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Research-integrated lectures with project-based learning and industry case studies",
                    Rating        = 0.0,
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Structured lectures with lab sessions and engineering design problems",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Seminar-style discussions blending molecular theory with drug discovery case studies",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Lecture-based with laboratory experiments and field investigation projects",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Interactive case-study approach combining theory with real-world business applications",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Discussion-based seminars with close reading and linguistic analysis exercises",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Lecture-based with design projects and structural analysis workshops",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Clinical rounds and case-based learning with surgical simulation",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Patient case discussions combined with evidence-based pharmacotherapy lectures",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Seminar discussions with policy analysis and health system case studies",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Lecture-based with lab practicals and computational physics problems",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Problem-based learning with field visits and environmental project assignments",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Rigorous lecture format with lab experiments in semiconductor characterization",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Applied learning with programming assignments and research-paper discussions",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Project-driven labs combining network analysis tools with applied ML models",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Theoretical lectures enriched with AI algorithm implementation labs",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Structured lectures with weekly algorithm problem-solving sessions",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Hands-on lab sessions with embedded hardware prototyping projects",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Collaborative learning with group projects and systems design workshops",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Proof-based lectures with rigorous problem sets and theoretical discussions",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Discussion-led seminars with literary analysis essays and linguistic tasks",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Lab-intensive teaching with lecture fundamentals and analytical problem solving",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Interactive workshops combining media theory with live digital media analysis",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Lecture-based with practical Cisco lab simulations and network design projects",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Field-based learning combining site visits with theoretical conservation frameworks",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Case-study discussions with policy analysis reports and governance simulations",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Research-oriented lectures with simulation-based labs and industry project integration",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Problem-solving lectures with MATLAB simulations and hands-on mechanical labs",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Analytical lectures with research paper reviews and communication system design tasks",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Field trips combined with classroom lectures and environmental impact assessments",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Applied lectures with lab-scale membrane fabrication and process design projects",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Interdisciplinary labs merging electronics and biology for medical device design",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Flipped classroom with startup case studies and entrepreneurship workshops",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Lab-intensive teaching with inquiry-based experiments and scientific writing",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Clinical scenario-based lectures combined with pharmacy practice labs",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Studio-based critique sessions with design projects and site analysis",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Text-analysis seminars with translation workshops and comparative literary discussions",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Problem-based learning with quantitative analysis assignments and business simulations",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Lab-based sessions focusing on formulation development and drug release analysis",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Quantitative case analysis with financial modeling exercises and risk scenario workshops",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Hands-on cybersecurity labs with CTF challenges and security tool demonstrations",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Research-integrated teaching with Python-based ML projects and paper reading groups",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Simulation-based clinical training with case debriefs and skills lab practice",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Campaign-based learning with live social media analytics and brand strategy projects",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Applied ML workshops with real clinical dataset analysis and research presentations",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Lecture-based with molecular modeling labs and drug design case studies",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Blended learning with e-learning platform demonstrations and technology adoption research",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Project-based labs with medical device prototyping and clinical technology integration",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Case-driven lectures with ERP simulations and IT governance framework analysis",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Industry-connected workshops with FinTech startup case studies and live demos",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Socratic method seminars with legal case analysis and moot court exercises",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Experiential learning with business plan competitions and hospitality industry visits",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Lab-centred instruction with industrial chemistry demonstrations and material testing",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Field measurement exercises combined with hydrological modeling and project reports",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Lecture-based with networking lab practicals and hardware design projects",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Hands-on programming labs with project-based assignments and system design exercises",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Foundational lecture delivery with applied problem sets tailored to engineering students",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Clinical case presentations with bedside teaching and diagnostic reasoning workshops",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Industry-aligned project labs with robotics prototyping and control system design",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Engineering problem-solving lectures with real-world transportation system case studies",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Lab-intensive security courses with penetration testing exercises and protocol analysis",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Applied research-driven courses linking industry partnerships with energy system design",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Project-based workshops with satellite fabrication labs and manufacturing simulation",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Hands-on AI coding labs with competition-style challenges and research paper walkthroughs",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
                ...
                new Professor
                {
                    ...
                    TeachingStyle = "Simulation-focused lectures with MATLAB energy modelling and radiation shielding design",
                    Rating        = 0.0,
                    ImageUrl      = null,
                    IsDeleted     = false,
                    CreatedAt     = DateTime.UtcNow
